...
![](./../../img/section-3/3_5_3.png)

NEAR Walletに接続している時

![](./../../img/section-3/3_5_4.png)
...
![](./../../img/section-3/3_5_9.png)

`Wallet`のページを表示し、右下の`Recent activity`で宿泊料を受け取っていたら確認完了です！

![](./../../img/section-3/3_5_10.png)
![](./../../img/section-3/3_5_11.png)
